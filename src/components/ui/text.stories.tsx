...
const meta = {
  ...
  argTypes: {
    role: {
      control: 'select',
      options: ['expression', 'reading', 'gloss', 'body', 'label', 'support', 'overline'],
    },
    align: {
      control: 'select',
...
export const ContentVersusChrome: Story = {
  args: { children: '' },
  render: () => (
    <div className="flex max-w-[342px] flex-col gap-block">
      <div className="flex flex-col gap-gap">
        ...
        <Text role="body">Softer than 〜してください. Safe with people you have just met.</Text>
      </div>
      <div className="flex flex-col gap-gap">
